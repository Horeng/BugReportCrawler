...
public class A_Main {
	...
	static int struct = 0;//Structural
	public static void main(String[] a) throws Exception
	{
		ArrayList<Integer> bugID = new ArrayList<Integer>();
		ArrayList<Integer> textbugID = new ArrayList<Integer>();
		ArrayList<ExtBugReport> bugRepository = B_XMLReader.parser(path+"Extended" +project+"BugRepository.xml");
		...
		for(int i = 0; i<bugRepository.size(); i++){
			...
			ArrayList<Comment> commentList = bugreport.getCommentList();
